...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user('aksdfj@gmail.com', 'testPass')
    ...
    def test_creating_recipe_with_ingredients(self):
        """Test creating recipe with ingredeints"""
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_upload_image_bad_request(self):
        ...
        res = self.client.post(
            url, {'image': 'invalid imgae'}, format='multipart')
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='another vegetable')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Beaf')
